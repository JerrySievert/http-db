...
function create (userData, callback) {
  ...
  retrieve(userData.username, function (err, user) {
...
function authStoreByUsername (store, username, callback) {
  ...
  // fetch the user data
  retrieve(username, function (err, userData) {
    if (err) {
      callback(err);
    } else {
...
function login (username, password, callback) {
  ...
  retrieve(username, function (err, user) {
...
function changePassword (username, oldPassword, newPassword, callback) {
  login(username, oldPassword, function (err, userData) {
    if (err) {
      return callback(err);
    }
